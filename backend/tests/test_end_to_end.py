...
class TestEndToEndWorkflows:
    ...
    def test_character_creation_workflow(self):
        ...
        try:
            from app.models.game_models import CreateCharacterRequest, Race, CharacterClass, Abilities
            ...
            assert all(ability in frontend_request["abilities"] 
    ...
    def test_campaign_creation_workflow(self):
        ...
        try:
            ...
            required_fields = ["id", "name", "setting", "tone", "homebrew_rules", "characters"]
    ...
    def test_image_generation_workflow(self):
        ...
        try:
            ...
            assert frontend_request["image_type"] in ["character_portrait", "scene_illustration", "item_visualization"]
