...
class TestParameterizedCombatActions:
    ...
    @pytest.mark.parametrize("action_factory,expected_fields", [
        (AttackActionFactory, ["action_type", "actor_id", "target_id", "success", "message", "attack_roll"]),
        (SpellAttackActionFactory, ["action_type", "actor_id", "target_id", "success", "message", "attack_roll", "spell_attack_bonus"]),
    ])
    ...
    @pytest.mark.parametrize("damage_roll,expected_success", [
    ...
    @pytest.mark.parametrize("action_type,factory_class", [
    ...
    @pytest.mark.parametrize("save_type,dc,expected_modifier", [
    ...
    @pytest.mark.parametrize("spell_name,damage_type,save_type", [
    ...
    @pytest.mark.slow
    @pytest.mark.parametrize("encounter_size,expected_processing_time", [
