...
class TestInventorySystem:
    ...
    def test_item_stacking_logic(self):
        ...
        assert (item1["name"] == item2["name"] and 
                item1["type"] == item2["type"] and
                not item1.get("magical", False) and
                not item2.get("magical", False))
    ...
    async def test_inventory_crud_interface(self):
        ...
        mock_scribe.add_to_inventory = AsyncMock(return_value={
            "inventory": [{"id": "item_123", "name": "Test Item", "quantity": 1}],
            "added_item": {"id": "item_123", "name": "Test Item", "quantity": 1}
        })
        
        # Mock get_inventory
        mock_scribe.get_inventory = AsyncMock(return_value={
        ...
        mock_scribe.remove_from_inventory = AsyncMock(return_value={
            "character_id": "char_123",
        ...
        mock_scribe.update_inventory_item = AsyncMock(return_value={
            "character_id": "char_123",
            "updated_item": {"id": "item_123", "name": "Updated Item", "quantity": 1},
            "inventory": [{"id": "item_123", "name": "Updated Item", "quantity": 1}]
        })
        ...
        mock_scribe.remove_from_inventory.assert_called_once_with("char_123", "item_123", 1)
        
        # Test update operation
        updates = {"name": "Updated Item"}
        result = await mock_scribe.update_inventory_item("char_123", "item_123", updates)
        assert "updated_item" in result
        mock_scribe.update_inventory_item.assert_called_once_with("char_123", "item_123", updates)
    ...
    async def test_equipment_interface(self):
        ...
        # Mock equip_item
        mock_scribe.equip_item = AsyncMock(return_value={
            "character_id": "char_123",
            "equipped_item": {"id": "sword_123", "name": "Iron Sword", "type": "sword"},
            "slot": "main_hand",
            "previously_equipped": None,
            "equipment": {"main_hand": {"id": "sword_123", "name": "Iron Sword", "type": "sword"}},
            "inventory": []
        })
        
        # Mock unequip_item
        mock_scribe.unequip_item = AsyncMock(return_value={
            "character_id": "char_123",
            "unequipped_item": {"id": "sword_123", "name": "Iron Sword", "type": "sword"},
            "slot": "main_hand",
            "equipment": {},
            "inventory": [{"id": "sword_123", "name": "Iron Sword", "type": "sword"}]
        })
        ...
        mock_scribe.equip_item.assert_called_once_with("char_123", "sword_123", "main_hand")
    ...
    async def test_encumbrance_interface(self):
        ...
        mock_scribe.calculate_encumbrance = AsyncMock(return_value={
            "character_id": "char_123",
            "total_weight": 50,
    ...
    async def test_item_effects_interface(self):
        ...
        mock_scribe.apply_item_effects = AsyncMock(return_value={
            "character_id": "char_123",
            "stat_modifiers": {
                "strength": 2,
                "dexterity": 0,
