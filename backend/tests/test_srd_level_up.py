...
class TestSRDLevelUp:
    ...
    async def test_level_up_adds_class_features(self, scribe_agent):
        ...
        fighter_data = {
            ...
            "proficiency_bonus": 2,
            "features": [
                {"name": "Fighting Style", "description": "...", "type": "class_choice", "source": "class", "level_gained": 1},
                {"name": "Second Wind", "description": "...", "type": "healing", "source": "class", "level_gained": 1}
            ]
        }
        ...
        with patch('app.agents.scribe_agent.get_session') as mock_session:
            ...
            with patch('app.plugins.rules_engine_plugin.RulesEnginePlugin') as mock_rules:
                ...
                mock_rules_instance.calculate_level_up_hp.return_value = {"total_hp_gain": 7}
                mock_rules_instance.calculate_proficiency_bonus.return_value = {"proficiency_bonus": 2}
                mock_rules_instance.check_asi_eligibility.return_value = {"asi_remaining": 0}
                mock_rules_instance.asi_levels = [4, 6, 8, 12, 14, 16, 19]
            
                result = await scribe_agent.level_up_character("test_fighter", {"strength": 1, "constitution": 1})
                ...
                class_feature_added = any("Class Feature: Action Surge" in feature for feature in features_gained)
                assert class_feature_added, f"Expected Action Surge to be added, got: {features_gained}"
    ...
    async def test_level_up_preserves_existing_features(self, scribe_agent):
        ...
        wizard_data = {
            ...
            "proficiency_bonus": 2,
            "features": [
                {"name": "Spellcasting", "description": "...", "type": "spellcasting", "source": "class", "level_gained": 1},
                {"name": "Arcane Recovery", "description": "...", "type": "spellcasting", "source": "class", "level_gained": 1},
                {"name": "Darkvision", "description": "...", "type": "racial", "source": "race", "level_gained": 1}
            ]
        }
        ...
        with patch('app.agents.scribe_agent.get_session') as mock_session:
            ...
            result = await scribe_agent.level_up_character("test_wizard", {"intelligence": 2})
    ...
    async def test_level_up_multiple_levels_adds_all_features(self, scribe_agent):
        ...
        rogue_data = {
            ...
            "proficiency_bonus": 2,
            "features": [
                {"name": "Expertise", "description": "...", "type": "skill", "source": "class", "level_gained": 1},
                {"name": "Sneak Attack", "description": "...", "type": "combat", "source": "class", "level_gained": 1}
            ]
        }
        ...
        with patch('app.agents.scribe_agent.get_session') as mock_session:
            ...
            with patch('app.plugins.rules_engine_plugin.RulesEnginePlugin') as mock_rules:
                ...
                mock_rules_instance.calculate_level_up_hp.return_value = {"total_hp_gain": 6}
                mock_rules_instance.calculate_proficiency_bonus.return_value = {"proficiency_bonus": 2}
                mock_rules_instance.check_asi_eligibility.return_value = {"asi_remaining": 0}
                ...
                features_gained = result.get("features_gained", [])
                class_feature_added = any("Class Feature: Roguish Archetype" in feature for feature in features_gained)
                assert class_feature_added, f"Expected Roguish Archetype to be added, got: {features_gained}"