    ...
    def test_combat_cartographer_agent_skills_registration(self):
        ...
        with patch.dict(os.environ, test_env), \
            ...
            with patch('app.kernel_setup.kernel_manager') as mock_manager, \
                ...
                assert hasattr(cartographer, 'map_generation'), "Missing map_generation plugin reference"
                assert hasattr(cartographer, 'tactical_analysis'), "Missing tactical_analysis plugin reference"
                assert hasattr(cartographer, 'terrain_assessment'), "Missing terrain_assessment plugin reference"
                assert hasattr(cartographer, 'battle_positioning'), "Missing battle_positioning plugin reference"
                assert hasattr(cartographer, 'environmental_hazards'), "Missing environmental_hazards plugin reference"
    ...
    def test_combat_cartographer_skills_plugin_types(self):
        ...
        with patch.dict(os.environ, test_env), \
            ...
            with patch('app.kernel_setup.kernel_manager') as mock_manager, \
                ...
                assert isinstance(cartographer.tactical_analysis, TacticalAnalysisPlugin)
                assert isinstance(cartographer.terrain_assessment, TerrainAssessmentPlugin)
                assert isinstance(cartographer.battle_positioning, BattlePositioningPlugin)
                assert isinstance(cartographer.environmental_hazards, EnvironmentalHazardsPlugin)
