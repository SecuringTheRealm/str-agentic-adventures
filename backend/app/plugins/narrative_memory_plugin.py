...
class NarrativeMemoryPlugin:
    ...
    DATA_FILE = (
        Path(__file__).resolve().parent.parent.parent / "data" / "narrative_memory.json"
    )
    ...
    def __init__(self) -> None:
        ...
        self.story_arcs: Dict[str, Any] = {}
        self.character_arcs: Dict[str, Any] = {}

        self._load_data()

    def _load_data(self) -> None:
        """Load memory data from disk if available."""
    ...
    def _save_data(self) -> None:
        ...
        try:
            ...
            logger.error("Failed to save narrative memory: %s", exc)
