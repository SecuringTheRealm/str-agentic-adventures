...
async def handle_websocket_message(message: Dict[str, Any], websocket: WebSocket, campaign_id: str = None):
...
async def handle_dice_roll(message: Dict[str, Any], websocket: WebSocket, campaign_id: str = None):
...
async def handle_game_update(message: Dict[str, Any], websocket: WebSocket, campaign_id: str = None):
...
async def handle_character_update(message: Dict[str, Any], websocket: WebSocket, campaign_id: str = None):
...
async def broadcast_dice_roll(campaign_id: str, player_name: str, notation: str, result: Dict[str, Any]):
...
async def broadcast_game_state_update(campaign_id: str, update_type: str, data: Dict[str, Any]):
...
async def broadcast_character_update(campaign_id: str, character_id: str, update_data: Dict[str, Any]):
