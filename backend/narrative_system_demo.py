...
async def demonstrate_narrative_system() -> None:
    ...
    print(
        "The party arrives at a crossroads. An ancient map shows three possible paths to the crown:"
    )
...
async def demonstrate_narrator_agent_integration() -> None:
    ...
    try:
        ...
        print(
            "   'You find yourself in Ancient Ruins of the Lost Kingdom during twilight."
        )
        print(
            "    Mystery hangs in the air like a thick fog, hinting at secrets yet to be discovered."
        )
        print(
            "    Your ongoing adventures in The Lost Crown of Eldoria weigh on your mind.'"
        )
