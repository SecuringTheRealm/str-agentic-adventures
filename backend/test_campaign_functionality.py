...
class TestCampaignGeneration:
    ...
    async def test_generate_world_description_fantasy(self):
        ...
        description = await generate_world_description("Test Realm", "fantasy", "heroic", [])
    ...
    async def test_generate_world_description_with_homebrew(self):
        ...
        description = await generate_world_description("Test World", "fantasy", "dark", homebrew_rules)
