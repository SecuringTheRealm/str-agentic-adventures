...
async def test_agent_integration():
    ...
    with patch.dict(os.environ, {
        ...
        with patch('app.kernel_setup.kernel_manager.create_kernel') as mock_kernel_manager:
            mock_kernel = Mock()
            ...
            action_result = await agent.process_combat_action(encounter["id"], attack_action)
            ...
            spell_result = await agent.process_combat_action(encounter["id"], spell_attack)
            ...
            print(f"✓ Combat started with {len(combat_result['turn_order'])} participants")
