...
class TestCombatActionProcessing:
    ...
    def setup_methods(self) -> None:
        ...
        def _process_attack_action(action_data, result, rules_plugin):
            ...
            try:
                ...
                if "error" in attack_result:
                    result["message"] = (
                        f"Error resolving attack: {attack_result['error']}"
                    )
                    return result
        ...
        def _process_movement_or_simple_action(action_data, result):
            ...
            if action_type == "move":
                ...
                return _process_skill_check_action(
                    stealth_data, result, self.rules_plugin
                )
        ...
        def _process_contested_action(action_data, result, rules_plugin):
            ...
            defender_skill_proficient = action_data.get(
    ...
    def test_movement_actions(self) -> None:
        ...
        # Test dash action
        dash_data = {"type": "dash", "actor_id": "player1"}
        ...
        # Test dodge action
        dodge_data = {"type": "dodge", "actor_id": "player1"}
